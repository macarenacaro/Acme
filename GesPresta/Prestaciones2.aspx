...
guion y, 3 dígitos" ControlToValidate="txtCodPre" CssClass="expresion" ValidationExpression="\d{3}-\d{3}-\d{3}"></asp:RegularExpressionValidator>
                ...
                <asp:TableCell runat="server">
                    <asp:DropDownList ID="ddlTipPre" runat="server" CssClass="drpDown">
                        ...
                        <asp:ListItem Selected="false" Value="Otras"> Otras </asp:ListItem>
                                    ...
                                    <asp:Button ID="btnVerPrestaciones" runat="server" Text="Ver Prestaciones" CausesValidation="False" OnClick="btnVerPrestaciones_Click" CssClass="btns" />
                </asp:TableCell>
            </asp:TableRow>
        ...
        <asp:Table ID="Table2" runat="server" Height="86px" Width="927px">
            <asp:TableRow runat="server">
                ...
                <asp:TableCell runat="server">                  
                    ...
                    <asp:Button ID="btnSeleccionar" runat="server" Text="Seleccionar" CausesValidation="False" Visible="False" OnClick="btnSeleccionar_Click" CssClass="btns" />
              </asp:TableCell> 
